...
const CountDown = () => {
    ...
    const calculateTimeLeft = () => {
        ...
        if (difference > 0) {
            ...
            // Reset to 0 when the countdown ends
            setTimeLeft({
                days: 0,
                hours: 0,
                minutes: 0,
            ...
            <div className="container">
                <div className="row justify-content-end">
                    <div className="col-12 col-md-8 col-lg-6 translucent-bg">
                        ...
                        {/* <!-- Counter --> */}
                        <div className="d-flex mb-9 my-3">
                            <div className="text-center">
                                <div className="fs-1 fw-bolder text-primary pri">{formatTime(timeLeft.days)}</div>
                                <div className="heading-xxs text-muted pri">Days</div>
                            </div>
                            <div className="px-1 px-md-4">
                                <div className="fs-2 fw-bolder text-primary pri">:</div>
                            ...
                            <div className="text-center">
                                <div className="fs-1 fw-bolder text-primary pri">{formatTime(timeLeft.hours)}</div>
                                <div className="heading-xxs text-muted pri">Hours</div>
                            </div>
                            <div className="px-1 px-md-4">
                                <div className="fs-2 fw-bolder text-primary pri">:</div>
                            ...
                            <div className="text-center">
                                <div className="fs-1 fw-bolder text-primary pri">{formatTime(timeLeft.minutes)}</div>
                                <div className="heading-xxs text-muted pri">Minutes</div>
                            </div>
                            <div className="px-1 px-md-4">
                                <div className="fs-2 fw-bolder text-primary pri">:</div>
                            ...
                            <div className="text-center">
                                <div className="fs-1 fw-bolder text-primary pri">{formatTime(timeLeft.seconds)}</div>
                                <div className="heading-xxs text-muted pri">Seconds</div>
                            </div>
                        </div>
